...
- [x] M11 detail panel (JSON tree, raw, fields, filter for/out, copy), row selection with keyboard navigation, NDJSON copy, term highlighting
- [ ] M12+ export and sessions, packaging
